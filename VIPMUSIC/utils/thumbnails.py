...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("VIPMUSIC/assets/bad/font2.ttf", 30)
    font = ImageFont.truetype("VIPMUSIC/assets/bad/font.ttf", 30)
    title_font = ImageFont.truetype("VIPMUSIC/assets/bad/font3.ttf", 45)
    ...
    play_icons = Image.open("VIPMUSIC/assets/bad/play_icons.png")
